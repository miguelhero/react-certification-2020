const resp = [
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: '772_6g1rMN8' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: 'gn594mcnyuE' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: 'PrZHBTv3fjw' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: 'UTsBkhu-UGw' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: 'iszLGKZeFsk' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: 'elEAnqU8KuY' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: 'w6MY2nBpjkA' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: 't_O_dnmfgrA' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: 'WKolloYx7Gw' },
    snippet: {
  ...
  },
  {
    ...
    id: { kind: 'youtube#video', videoId: '8xCVIhEircY' },
    snippet: {
  ...
  {
    kind: 'youtube#searchResult',
    etag: '5WsXkY4mdeFOVZtNLn0GwMTFU30',
    id: { kind: 'youtube#video', videoId: 'FlYT5uR-m9w' },
    snippet: {
      publishedAt: '2020-09-16T01:45:35Z',
      channelId: 'UCPGzT4wecuWM0BH9mPiulXg',
      title: 'Wizeline Webinars | How To Monetize Your Data Webinar',
      description:
        "In today's world, data has become a commodity. But the ability to monetize it adequately represents the real advantage of thriving businesses. Watch the ...",
      thumbnails: {
        default: {
          url: 'https://i.ytimg.com/vi/FlYT5uR-m9w/default.jpg',
          width: 120,
          height: 90,
        },
        medium: {
          url: 'https://i.ytimg.com/vi/FlYT5uR-m9w/mqdefault.jpg',
          width: 320,
          height: 180,
        },
        high: {
          url: 'https://i.ytimg.com/vi/FlYT5uR-m9w/hqdefault.jpg',
          width: 480,
          height: 360,
        },
      },
      channelTitle: 'Wizeline',
      liveBroadcastContent: 'none',
      publishTime: '2020-09-16T01:45:35Z',
    },
  },
  {
    kind: 'youtube#searchResult',
    etag: '75T8WxL7Dx16-gfJEXwzaC_UDx8',
    id: { kind: 'youtube#video', videoId: 'A9wOgGO5Svw' },
    snippet: {
